...
<body>
        ...
        <div id="sidebar" class="nav-collapse " tabindex="5000" style="overflow: hidden; outline: none;">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu dcjq-parent-li">
                    <a href=" {{ route('admin/quienessomos') }} " class="active">
    ...
    <section id="container">
        ...
        <section id="main-content">
            <section class="wrapper site-min-height">
                <h3><i class="fa fa-angle-right"></i>Página de ¿Quiénes sómos?</h3>
                <div class="row mt">
                    <div class="col-lg-12">
                       ...
                       @yield('quienesSomos')
                        ...
                        @yield('misionyvision')
                        @yield('valores')
                        @yield('filosofiainstitucional')
                        @yield('perfilpacientes')
                        @yield('terapias')
    ...
    @include('scriptAjax.quienesSomosAjax')
